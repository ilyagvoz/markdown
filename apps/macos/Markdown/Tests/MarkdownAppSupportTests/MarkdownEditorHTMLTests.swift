...
final class MarkdownEditorHTMLTests: XCTestCase {
    ...
    func testIncludesLivePreviewEditingBehaviors() {
        ...
        XCTAssertTrue(html.contains("function installLinkInteractions"))
        XCTAssertTrue(html.contains("function linkPayload"))
        XCTAssertTrue(html.contains("function hasLinkOpenModifier"))
        XCTAssertTrue(html.contains("function activateLink"))
        XCTAssertTrue(html.contains("post(\"linkHovered\", payload, false)"))
        XCTAssertTrue(html.contains("post(\"linkHoverEnded\", {}, false)"))
        XCTAssertTrue(html.contains("post(\"linkActivated\", payload, false)"))
        XCTAssertTrue(html.contains("addEventListener(\"contextmenu\""))
        XCTAssertTrue(html.contains("event.metaKey || event.ctrlKey"))
        XCTAssertTrue(html.contains("key === \"[\" || key === \"]\""))
